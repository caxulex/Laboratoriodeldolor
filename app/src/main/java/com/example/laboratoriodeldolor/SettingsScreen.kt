        ...
        Card(modifier = Modifier.fillMaxSize().padding(innerPadding).padding(16.dp)) {
            Column(modifier = Modifier.fillMaxSize().padding(start = 16.dp, end = 16.dp, top = 32.dp, bottom = 16.dp)) {
                ...
                Button(onClick = {
                    ...
                    tp.show()
                }, modifier = Modifier.fillMaxWidth().padding(top = 24.dp).height(48.dp), colors = androidx.compose.material3.ButtonDefaults.buttonColors(containerColor = MaterialTheme.colorScheme.primary)) {
                    Text(text = stringResource(id = R.string.reminder_time_label) + ": ${reminder.first.toString().padStart(2,'0')}:${reminder.second.toString().padStart(2,'0')}", color = MaterialTheme.colorScheme.onPrimary)
                }
                ...
                Button(onClick = { onNavigateToAbout() }, modifier = Modifier.fillMaxWidth().padding(top = 20.dp).height(48.dp)) {
