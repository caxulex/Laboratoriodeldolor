...
@Composable
fun BackUpperBodyExerciseScreen(onBack: () -> Unit = {}) {
    ...
    LazyColumn(modifier = Modifier.padding(start = 16.dp, end = 16.dp, top = 32.dp, bottom = 16.dp), contentPadding = androidx.compose.foundation.layout.PaddingValues(bottom = 24.dp)) {
            item {
                Text(text = stringResource(id = R.string.back_upper_body_routine_title), style = MaterialTheme.typography.headlineSmall)
